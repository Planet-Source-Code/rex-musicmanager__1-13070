...
Object = "{B0528CD1-F67E-11D2-8F8E-00C04F4C3B9F}#1.0#0"; "cddbcontrol.dll"
Object = "{25867224-9498-4E12-AB1F-500F2DAF5FAE}#1.0#0"; "Player.ocx"
Begin VB.Form frmMain 
   ...
   Begin CDDBCONTROLLibCtl.CDDBControl CDDBControl1 
      Height          =   615
      Left            =   8160
      OleObjectBlob   =   "frmMain2.frx":08CA
      TabIndex        =   22
      Top             =   120
      Width           =   615
   End
   ...
   Begin MSComctlLib.ImageList iL 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain2.frx":08EE
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain2.frx":13BA
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain2.frx":3B6E
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain2.frx":463A
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain2.frx":5314
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain2.frx":5FEE
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmMain2.frx":6CC8
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin VB.Menu mnuPlayList 
      ...
      Begin VB.Menu mnusep11 
         Caption         =   "-"
      End
      Begin VB.Menu mnuPlayerVisible 
         Caption         =   "&Visible"
         Checked         =   -1  'True
      End
   End
...
Private Sub mnuBrowse_Click()
    mCDDB.BrowseForCD (mCDDB.CDSerialNumber)
End Sub
...
Private Sub mnuPlayerVisible_Click()
    If mnuPlayerVisible.Checked = True Then
        mnuPlayerVisible.Checked = False
        Player.Visible = False
        topLine.Y1 = Player.tOp
        topLine.Y2 = Player.tOp
        Call mInterface.resize(Me)
    Else
        mnuPlayerVisible.Checked = True
        Player.Visible = True
        topLine.Y1 = Player.tOp + Player.Height + 50
        topLine.Y2 = Player.tOp + Player.Height + 50
        Call mInterface.resize(Me)
    End If
End Sub
...
' Play next song
Private Sub Player_ButtonForward()
    Call mMusicDevices.nextSong(Me)
    Call mMusicDevices.Play(Me)
End Sub
...
' Play Previous song
Private Sub Player_ButtonRewind()
    Call mMusicDevices.previousSong(Me)
End Sub
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    ElseIf Button.Index = 4 Then
        ...
        mMusicDevices.iCol = 3
        sbrMain.Panels(2).Text = lf.ListItems.Count - 1 & " files found"
    ElseIf Button.Index = 6 Then
        Call mInterface.ShowPreference
    End If
End Sub
...
Private Sub Toolbar1_ButtonMenuClick(ByVal ButtonMenu As MSComctlLib.ButtonMenu)
    If ButtonMenu.Key = "aCD" Then Call mCDDB.Initalize
